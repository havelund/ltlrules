...
input format of the tool, related to the examples in Section~\ref{sec:syntax-semantics}, which
are not expressible in (P)FLTL.
These properties are not expressible in the original first-order logic of \dejavu{} presented in \cite{HPU}. The properties are 
%
