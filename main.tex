...
\and
Doron Peled~\thanks{The research performed by this author was partially funded by Israeli Science Foundation grant 2239/15: 
``Runtime Measuring and Checking of Cyber Physical Systems''.
}
}
...
traces using formal techniques. RV is scalable and 
therefore has a big potential for infusion in software 
engineering practices. It includes e.g. monitoring the 
...
tool \dejavu{}  to support our extension and we perform some 
experiments.
...
\noindent {\bf Sketch of proof of Theorem~\ref{theo2}.}
